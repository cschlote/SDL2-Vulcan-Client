...
11. Dialog and modal support: add modal windows, disabled-background routing, default buttons, cancel buttons, and cursor feedback for blocked regions. Partial for `UiScreen` modal routing, blocked-background input, and modal Enter/Escape button dispatch.
