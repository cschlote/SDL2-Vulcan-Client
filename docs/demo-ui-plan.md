...
27. Add stable `UiWindow` identity once external window registries or restored layouts need it: generated id first, optional opaque application tag second, visible title never as identity.
