...
10. Keyboard navigation: add focus traversal order, Tab and Shift-Tab movement, activation keys, and modal focus containment. Partial for direct key handling in focused `UiTabBar` and `UiListBox`.
