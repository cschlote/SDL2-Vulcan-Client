...
The UiWindow Demo is the natural first place to test open and close transitions. The Controls Demo, Layout Demo, and future Media Demo are the natural places to test widget-local animation and animated images.
